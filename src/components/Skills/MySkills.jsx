...
const MySkills = () => {
  return (
    <div
      className="px-6 md:px-24 py-16 flex flex-col animate__animated animate__fadeInLeft"
      id="Skills"
    >
      <Typography className="text-4xl my-10">Skills</Typography>
      <div>
        <div className="progress-container mt-5 flex items-center justify-between">
          ...
          <Progress
            ...
            size="lg"
            color="orange"
            className="mx-3 w-11/12 animate__animated animate__fadeInRight"
          />
        </div>
        <div className="progress-container mt-5 flex items-center justify-between">
          <FontAwesomeIcon
